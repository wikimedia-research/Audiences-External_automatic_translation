...
{ source .bash_profile
  ...
  /home/neilpquinn-wmf/venv/bin/jupyter nbconvert --ExecutePreprocessor.timeout=600 --execute --to html external-automatic-translation/impact\ of\ external\ automatic\ translation\ services.ipynb
